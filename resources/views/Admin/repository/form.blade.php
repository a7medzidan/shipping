...
@section('content')
    ...
    <div class="card">
        <div class="card-header ">
            ...
            <form id="form" enctype="multipart/form-data" method="POST" action="{{route('repository.store')}}">
                @csrf
                ...
                <div id="tr-1" class="card mt-2 my-div">
                    ...
                    <div class="card-body">
                            ...
                            <div class="d-flex flex-column mb-7 fv-row col-sm-3">
                                ...
                                <!--end::Label-->
                                <input type="number" min="1" required="" id="shipment_pieces_number-1" name="age"
