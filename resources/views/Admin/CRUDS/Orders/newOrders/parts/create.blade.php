...
{{--                                    <!--begin::Label-->--}}
{{--                                    <label for="trader_id-1" class="d-flex align-items-center fs-6 fw-bold form-label mb-2">--}}
{{--                                        <span class="required mr-1">التاجر</span>--}}
{{--                                    </label>--}}
{{--                                    <!--end::Label-->--}}
{{--                                    <select class="form-control" name="trader_id[]" id="trader_id-1">--}}
...
{{--                                <div class="d-flex flex-column mb-7 fv-row col-sm-2">--}}
{{--                                    <!--begin::Label-->--}}
{{--                                    <label for="delivery_id-1" class="d-flex align-items-center fs-6 fw-bold form-label mb-2">--}}
{{--                                        <span class="required mr-1">المندوب</span>--}}
{{--                                    </label>--}}
{{--                                    <!--end::Label-->--}}
{{--                                    <select class="form-control" name="delivery_id[]" id="delivery_id-1">--}}
{{--                                        <option selected ></option>--}}
...
{{--                                </div>--}}
                                ...
                                <div class="d-flex flex-column mb-7 fv-row col-sm-3">
                                    ...
                                    <!--end::Label-->
                                    <input type="number" id="customer_phone-1" name="customer_phone[]" class="form-control"
                                           value="">
                                </div>
                                ...
                                <div class="d-flex flex-column mb-7 fv-row col-sm-3">
                                    <!--begin::Label-->
                                    <label for="delivery_time-1"
                                           class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                        <span class="required mr-1"> وقت التسليم</span>
                                    </label>
                                    <!--end::Label-->
                                    <input type="datetime-local" id="delivery_time-1" name="delivery_time[]"
            ...
            var order=`
                    ...
                    <div class="card-body">
                        <div class="row  g-4">
                                ...
                                {{--    </label>--}}
                                {{--    <!--end::Label-->--}}
                                {{--    <select class="form-control" name="trader_id[]" id="trader_id-${x}">--}}
                                {{--        <option selected ></option>--}}
                                {{--        @foreach($traders as $trader)--}}
                                {{--           <option value="{{$trader->id}}">{{$trader->name}}</option>--}}
                                {{--        @endforeach--}}
                                ...
                                <div class="d-flex flex-column mb-7 fv-row col-sm-3">
                                    ...
                                    <select id='trader_id-${x}' name="trader_id[]" style='width: 200px;'>
                                        <option selected disabled>- ابحث عن تاجر</option>
                                    </select>
                                </div>
