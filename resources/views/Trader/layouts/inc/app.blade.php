...
<html lang="en" >
 ...
 <?php } ?>
    ...
    <head>
		...
		@include('Trader.layouts.inc.head')
...
@include('Trader.layouts.inc.main-header')
<!-- ========== Right Sidebar Start ========== -->
@include('Trader.layouts.inc.main-sidebar')
...
@yield('page-header')
            	...
            	@include('Trader.layouts.inc.footer')
				  </div>
            <!-- end main content-->
        ...
        <!-- END layout-wrapper -->
  <!-- Right Sidebar -->
@include('Trader.layouts.inc.sidebar')
				@include('Trader.layouts.inc.footer-scripts')
 ...
 <script>
     ...
     $(document).on('click','.editProfile',function (e) {
         ...
         var url = '{{route('traderProfile.show',trader()->user()->id)}}';
