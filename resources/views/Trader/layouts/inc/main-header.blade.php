...
{{--            </div>--}}
            ...
            <div class="dropdown d-inline-block" id="page-header-user-dropdown">
                <button type="button" class="btn header-item waves-effect"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{get_file(trader()->user()->logo)}}"
                        alt="Header Avatar">
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item editProfile" href=""><i class="mdi mdi-account-circle font-size-17 text-muted align-middle me-1"></i> {{ trader()->user()->name??'' }}</a>
                    <div class="dropdown-divider"></div>
