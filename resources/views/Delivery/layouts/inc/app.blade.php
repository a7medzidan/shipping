...
<html lang="en" >
 ...
 <?php } ?>
    ...
    <head>
		...
		@include('Delivery.layouts.inc.head')
...
@include('Delivery.layouts.inc.main-header')
<!-- ========== Right Sidebar Start ========== -->
@include('Delivery.layouts.inc.main-sidebar')
...
@yield('page-header')
            	...
            	@include('Delivery.layouts.inc.footer')
				  </div>
            <!-- end main content-->
        ...
        <!-- END layout-wrapper -->
  <!-- Right Sidebar -->
@include('Delivery.layouts.inc.sidebar')
				@include('Delivery.layouts.inc.footer-scripts')
 ...
 <script>
     @isset(trader()->user()->id)

     $(document).on('click','.editProfile',function (e) {
         e.preventDefault()
         var id = $(this).attr('id');

         var url = '{{route('deliveryProfile.show',trader()->user()->id)}}';
