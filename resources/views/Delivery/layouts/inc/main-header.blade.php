    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{route('delivery.index') }}" class="logo logo-light">
                    <span class="logo-sm">
...
{{--            </div>--}}
            ...
            <div class="dropdown d-inline-block" id="page-header-user-dropdown">
                <button type="button" class="btn header-item waves-effect"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{get_file(delivery()->user()->image)}}"
                        alt="Header Avatar">
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item editProfile" href=""><i class="mdi mdi-account-circle font-size-17 text-muted align-middle me-1"></i> {{ delivery()->user()->name??'' }}</a>
                    <div class="dropdown-divider"></div>
