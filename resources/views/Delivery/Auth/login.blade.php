@extends('Delivery.Auth.layouts.inc.app')
            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card mt-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="p-2 mt-4">
                            <form action="{{route('delivery.postLogin')}}" method="post" enctype="multipart/form" id="Form">
                                @csrf
                                <div class="mb-3">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data == 200) {
                        ...
                        window.setTimeout(function () {
                            window.location = "{{route('delivery.index')}}"
                        }, 1000);
